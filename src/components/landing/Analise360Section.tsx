...
import analise360Atual from "@/assets/landing/analise360-atual.png";
import analise360Frente from "@/assets/landing/analise360-frente.png";
import analise360Inicial from "@/assets/landing/analise360-inicial.png";
import analise360Relatorio from "@/assets/landing/analise360-relatorio.png";
...
const Compare = () => (
  <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] p-3.5">
    ...
    <div className="mt-3 grid grid-cols-2 gap-3">
      {[
        { label: "Inicial", date: "10/01/2025", image: analise360Inicial },
        { label: "Atual", date: "20/05/2025", image: analise360Atual },
      ].map((item, index) => (
        <div
          key={item.label}
